...
CREATE OR REPLACE PROCEDURE PROC_PRODUTIVIDADE_DETALHE 
(
  DTH_INICIAL IN VARCHAR2 
, DTH_FINAL IN VARCHAR2 
) AS 
BEGIN
...
INSERT INTO PRODUTIVIDADE_DETALHE (DSC_ATIVIDADE, IDENTIDADE, COD_PESSOA, COD_PRODUTO, DTH_INICIO , DTH_FIM , QTD_PRODUTOS, QTD_VOLUMES, QTD_CUBAGEM, QTD_PESO, QTD_PALETES, QTD_CARGA)

SELECT DSC_ATIVIDADE, IDENTIDADE, COD_PESSOA, COD_PRODUTO, TO_DATE(DTH_INICIO) ,  TO_DATE(DTH_FIM) , QTD_PRODUTOS, QTD_VOLUMES, QTD_CUBAGEM, QTD_PESO, QTD_PALETES, QTD_CARGA
FROM (  
	/*
