...
BEGIN
 ...
 BETWEEN TO_DATE(DTH_INICIO,'DD/MM/YYYY')
  ...
  INSERT INTO APONTAMENTO_PRODUTIVIDADE (DSC_ATIVIDADE, COD_PESSOA, DTH_ATIVIDADE , QTD_PRODUTOS, NUM_RUA, QTD_VOLUMES, QTD_CUBAGEM, QTD_PESO, QTD_PALETES, QTD_CARGA)

SELECT DSC_ATIVIDADE, COD_PESSOA, TO_DATE(DTH_ATIVIDADE), QTD_PRODUTOS, NUM_RUA, QTD_VOLUMES, QTD_CUBAGEM, QTD_PESO, QTD_PALETES, QTD_CARGA
...
UNION
SELECT DSC_ATIVIDADE, COD_PESSOA, DTH_ATIVIDADE , QTD_PRODUTOS, NUM_RUA, QTD_VOLUMES, QTD_CUBAGEM, QTD_PESO, QTD_PALETES, QTD_CARGA
  FROM (
SELECT 'SEPARACAO' as DSC_ATIVIDADE,
        ...
        COUNT(DISTINCT NVL(A.NUM_RUA,0)) as NUM_RUA,
