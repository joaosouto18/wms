INSERT INTO VERSAO (DTH, NUMERO_VERSAO, SCRIPT) VALUES (SYSDATE, '6.18.0','01-cod-externo-pedido.sql');

ALTER TABLE PEDIDO ADD COD_EXTERNO VARCHAR2(50 BYTE);

ALTER TABLE PEDIDO ADD NUM_SEQUENCIAL NUMBER (8);

UPDATE PEDIDO SET COD_EXTERNO = COD_PEDIDO;

CREATE SEQUENCE SQ_PEDIDO_01
INCREMENT BY 1
START WITH 100000053
