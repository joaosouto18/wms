...
INSERT INTO VERSAO (DTH, NUMERO_VERSAO, SCRIPT) VALUES (SYSDATE, 'v8.0', '01-wms-root.sql');
...
ALTER TABLE ACAO_INTEGRACAO MODIFY (COD_ACAO_RELACIONADA VARCHAR(100));
UPDATE  ACAO_INTEGRACAO SET COD_ACAO_RELACIONADA = TRIM(COD_ACAO_RELACIONADA) WHERE COD_ACAO_RELACIONADA IS NOT NULL;
