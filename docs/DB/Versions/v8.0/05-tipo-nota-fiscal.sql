...
ALTER TABLE NOTA_FISCAL RENAME COLUMN COD_FORNECEDOR TO COD_EMISSOR;

ALTER TABLE NOTA_FISCAL DROP CONSTRAINT FK_NOFIS_FORNE;
...
ALTER TABLE TIPO_NOTA_ENTRADA ADD (IND_DEVOL_DEFAULT CHAR(1) DEFAULT 0 NOT NULL);
...
UPDATE TIPO_NOTA_ENTRADA SET IND_SYS_DEFAULT = 1, DSC_TIPO_NOTA_ENTRADA = 'DEVOLUÇÃO', IND_DEVOL_DEFAULT = 1 WHERE COD_TIPO_NOTA_ENTRADA = 2;
DELETE FROM TIPO_NOTA_ENTRADA WHERE IND_SYS_DEFAULT = 0;


ALTER TABLE NOTA_FISCAL ADD (TIPO_BKP NUMBER(8));
UPDATE NOTA_FISCAL SET TIPO_BKP = COD_TIPO_NOTA_FISCAL WHERE 1 = 1;
UPDATE NOTA_FISCAL SET COD_TIPO_NOTA_FISCAL = NULL WHERE 1 = 1;
ALTER TABLE NOTA_FISCAL MODIFY COD_TIPO_NOTA_FISCAL NUMBER(8);
UPDATE NOTA_FISCAL SET COD_TIPO_NOTA_FISCAL = TIPO_BKP WHERE 1 = 1;
ALTER TABLE NOTA_FISCAL DROP COLUMNALTER TABLE TIPO_NOTA_ENTRADA MODIFY (IND_EMISSOR NOT NULL, COD_EXTERNO NOT NULL) TIPO_BKP;

UPDATE NOTA_FISCAL SET COD_TIPO_NOTA_FISCAL = 1 WHERE COD_TIPO_NOTA_FISCAL = 624;
UPDATE NOTA_FISCAL SET COD_TIPO_NOTA_FISCAL = 2 WHERE COD_TIPO_NOTA_FISCAL = 625;

DELETE FROM PARAMETRO WHERE DSC_PARAMETRO = 'COD_FORNECEDOR_DEVOLUCAO';
