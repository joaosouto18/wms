...
INSERT INTO VERSAO (DTH, NUMERO_VERSAO, SCRIPT) VALUES (SYSDATE, '7.16', '01-relatorios-customizados.sql');
...
(
  ...
  DSC_GRUPO_RELATORIO       VARCHAR2 (200 BYTE) NOT NULL ,
...
CREATE TABLE RELATORIO_CUST_PERFIL_USUARIO
(
  COD_RELATORIO_CUSTOMIZADO NUMBER (8) NOT NULL ,
  COD_PERFIL_USUARIO NUMBER (8) NOT NULL
) LOGGING;
