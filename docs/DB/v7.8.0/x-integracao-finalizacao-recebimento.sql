INSERT INTO VERSAO (DTH, NUMERO_VERSAO, SCRIPT) VALUES (SYSDATE, '7.8.0', 'x-integracao-finalizacao-recebimento.sql');
...
insert into parametro (cod_parametro,cod_contexto_parametro,dsc_parametro,dsc_titulo_parametro,ind_parametro_sistema,cod_tipo_atributo,dsc_valor_parametro)
    values (sq_parametro_01.nextval, (select cod_contexto_parametro from contexto_parametro where dsc_contexto_parametro = 'INTEGRACAO'), 'UTILIZA_INTEGRACAO_RECEBIMENTO_ERP','Dispara integração de retorno genérico de conferencia de recebimento para o ERP','S','A','N');

insert into parametro (cod_parametro,cod_contexto_parametro,dsc_parametro,dsc_titulo_parametro,ind_parametro_sistema,cod_tipo_atributo,dsc_valor_parametro)
    values (sq_parametro_01.nextval, (select cod_contexto_parametro from contexto_parametro where dsc_contexto_parametro = 'INTEGRACAO'), 'ID_INTEGRACAO_FINALIZA_RECEBIMENTO_ERP','ID integração de retorno genérico de conferencia de recebimento para o ERP','S','A','');
