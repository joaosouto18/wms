...
BEGIN
  SELECT FUNC_CHECK_SCRIPT('xx-cod-carga-externo-varchar.sql', '') INTO CHECK_RESULT FROM DUAL ;
  IF (CHECK_RESULT <> 'TRUE') THEN
    DBMS_OUTPUT.PUT_LINE(CHECK_RESULT);
  ELSE
        INSERT INTO VERSAO (DTH, NUMERO_VERSAO, SCRIPT) VALUES (SYSDATE, '6','xx-cod-carga-externo-varchar.sql');
/************************************************************************
