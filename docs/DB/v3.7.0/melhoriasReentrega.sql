INSERT INTO recurso_acao (cod_recurso_acao, cod_recurso, cod_acao, dsc_recurso_acao) VALUES (SQ_RECURSO_ACAO_01.NEXTVAL, (SELECT COD_RECURSO FROM RECURSO WHERE NOM_RECURSO LIKE 'enderecamento:relatorio_ocupacao-cd'), (SELECT COD_ACAO FROM ACAO WHERE NOM_ACAO LIKE 'list'), 'Relat�rio de Ocupa��o por Produtos');
