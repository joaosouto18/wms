...
create table TEMP_PEDIDOS_FRACIONADOS
(
    COD_PEDIDO NUMBER(8),
    COD_PRODUTO NUMBER(8),
    COD_EMBALAGEM NUMBER(8),
    COD_VOLUME NUMBER(8),
    QTD NUMBER(8),
    RUA NUMBER(8),
    COD_CLIENTE NUMBER(8),
    COD_PRACA NUMBER(8),
    COD_LINHASEPARACAO NUMBER(8),
    TIPO NUMBER(8),
    COD_EXPEDICAO NUMBER(8)
 );
 
 CREATE INDEX pedido_temp ON TEMP_PEDIDOS_FRACIONADOS (COD_PEDIDO);
 CREATE INDEX embalagem_temp ON TEMP_PEDIDOS_FRACIONADOS (COD_EMBALAGEM);
 CREATE INDEX volume_temp ON TEMP_PEDIDOS_FRACIONADOS (COD_VOLUME);
 CREATE INDEX expedicao_temp ON TEMP_PEDIDOS_FRACIONADOS (COD_EXPEDICAO);
