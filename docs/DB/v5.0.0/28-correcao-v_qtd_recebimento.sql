INSERT INTO VERSAO (DTH, NUMERO_VERSAO, SCRIPT) VALUES (SYSDATE, '5.0.0','28-correcao-v_qtd_recebimento.sql');

CREATE OR REPLACE VIEW V_QTD_RECEBIMENTO ( QTD, COD_RECEBIMENTO, COD_PRODUTO, DSC_GRADE, COD_OS, COD_NORMA_PALETIZACAO, NUM_PESO) AS
