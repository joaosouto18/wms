...
INSERT INTO ACAO_INTEGRACAO (COD_ACAO_INTEGRACAO, COD_CONEXAO_INTEGRACAO, DSC_QUERY, COD_TIPO_ACAO_INTEGRACAO,IND_UTILIZA_LOG,DTH_ULTIMA_EXECUCAO)
 VALUES (2,1,'SELECT E.COD_PRODUTO, SUM(E.QTD) as ESTOQUE_GERENCIAL, SUM(E.QTD) as ESTOQUE_DISPONIVEL, SUM(E.QTD) as VALOR_ESTOQUE, 1 as CUSTO_UNITARIO, 1 as FATOR_UNIDADE_VENDA, ' || '''FD''' ||' as DSC_UNIDADE FROM ESTOQUE E GROUP BY COD_PRODUTO',601,'S',null);
