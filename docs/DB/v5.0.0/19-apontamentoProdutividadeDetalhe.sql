...
INSERT INTO PRODUTIVIDADE_DETALHE (DSC_ATIVIDADE, IDENTIDADE, COD_PESSOA, DSC_GRADE, COD_PRODUTO, DTH_INICIO , DTH_FIM , QTD_PRODUTOS, QTD_VOLUMES, QTD_CUBAGEM, QTD_PESO, QTD_PALETES, QTD_CARGA)

SELECT DSC_ATIVIDADE, IDENTIDADE, COD_PESSOA, COD_PRODUTO, DSC_GRADE, TO_DATE(DTH_INICIO) ,  TO_DATE(DTH_FIM) , QTD_PRODUTOS, QTD_VOLUMES, QTD_CUBAGEM, QTD_PESO, QTD_PALETES, QTD_CARGA
FROM (  
	/*
