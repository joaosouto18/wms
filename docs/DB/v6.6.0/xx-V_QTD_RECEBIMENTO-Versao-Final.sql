...
************************************************************************/
    ...
    EXECUTE IMMEDIATE 'CREATE OR REPLACE FORCE VIEW "V_QTD_RECEBIMENTO" ("QTD", "COD_RECEBIMENTO", "COD_PRODUTO", "DSC_GRADE", "COD_OS", "COD_NORMA_PALETIZACAO", "NUM_PESO") AS
    ...
    EXECUTE IMMEDIATE 'CREATE OR REPLACE FORCE VIEW "V_QTD_RECEBIMENTO_SINTETICA" ("QTD", "COD_RECEBIMENTO", "COD_PRODUTO", "DSC_GRADE", "COD_OS", "NUM_PESO") AS
    SELECT MIN(QTD.QTD) as QTD,
      QTD.COD_RECEBIMENTO,
      QTD.COD_PRODUTO,
      QTD.DSC_GRADE,
