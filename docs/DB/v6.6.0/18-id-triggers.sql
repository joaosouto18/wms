...
UPDATE ACAO_INTEGRACAO SET DSC_QUERY = 'SELECT ID, COD_FORNECEDOR, COD_PRODUTO, NOM_FORNECEDOR, CPF_CNPJ, DSC_GRADE, INSCRICAO_ESTADUAL, NUM_NOTA_FISCAL, COD_SERIE_NOTA_FISCAL, TO_CHAR(DAT_EMISSAO,''DD/MM/YYYY'') DAT_EMISSAO, TIPO_NOTA, DSC_PLACA_VEICULO, QTD_ITEM, VALOR_TOTAL, IND_PROCESSADO FROM TR_NOTA_FISCAL_ENTRADA WHERE 1 = 1 AND IND_PROCESSADO = ''N'' OR IND_PROCESSADO IS NULL ORDER BY NUM_NOTA_FISCAL, COD_SERIE_NOTA_FISCAL' WHERE TABELA_REFERENCIA = 'TR_NOTA_FISCAL_ENTRADA';