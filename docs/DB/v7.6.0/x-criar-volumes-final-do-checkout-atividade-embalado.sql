...
BEGIN
    SELECT FUNC_CHECK_SCRIPT('x-criar-volumes-final-do-checkout-atividade-embalado.sql', '') INTO CHECK_RESULT FROM DUAL;
    IF (CHECK_RESULT <> 'TRUE') THEN
        DBMS_OUTPUT.PUT_LINE(CHECK_RESULT);
    ELSE
        INSERT INTO VERSAO (DTH, NUMERO_VERSAO, SCRIPT)
        VALUES (SYSDATE, '7.6', 'x-criar-volumes-final-do-checkout-atividade-embalado.sql');
        /************************************************************************
...
************************************************************************/
        ...
        INSERT INTO ATIVIDADE (COD_ATIVIDADE, DSC_ATIVIDADE, COD_SETOR_OPERACIONAL) VALUES (SQ_ATIVIDADE_01.nextval, 'EMBALAGEM EXPEDIÇÃO', 18);
