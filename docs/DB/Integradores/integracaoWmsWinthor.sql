...
/*
 * INTEGRAÇÂO DE IMPRESSÃO DE ETIQUETAS
 */
INSERT INTO ACAO_INTEGRACAO (COD_ACAO_INTEGRACAO,COD_CONEXAO_INTEGRACAO,DSC_QUERY,COD_TIPO_ACAO_INTEGRACAO,IND_UTILIZA_LOG,DTH_ULTIMA_EXECUCAO)
  VALUES (15,1,'update pccarreg set pcnumviasmapa = 1, datamapa = sysdate where 1 = 1 :where ',
  608,'S',SYSDATE);
...
/*
 * INTEGRAÇÂO DE FINALIZAÇÃO DA EXPEDICAO
 */
INSERT INTO ACAO_INTEGRACAO (COD_ACAO_INTEGRACAO,COD_CONEXAO_INTEGRACAO,DSC_QUERY,COD_TIPO_ACAO_INTEGRACAO,IND_UTILIZA_LOG,DTH_ULTIMA_EXECUCAO)
