INSERT INTO VERSAO (DTH, NUMERO_VERSAO, SCRIPT) VALUES (SYSDATE, '3.8.0', 'pesoVariavel.sql');
...
ALTER TABLE RECEBIMENTO_CONFERENCIA
  ADD IND_DIVERGENCIA_PESO CHAR(1) DEFAULT 'N';
