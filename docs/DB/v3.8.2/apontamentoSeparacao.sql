...
ALTER TABLE ACAO MODIFY (NOM_ACAO VARCHAR2(45));
INSERT INTO ACAO (COD_ACAO,DSC_ACAO,NOM_ACAO) VALUES (SQ_ACAO_01.NEXTVAL, 'Conferente de separa��o de etiquetas', 'conferente-apontamento-separacao');
