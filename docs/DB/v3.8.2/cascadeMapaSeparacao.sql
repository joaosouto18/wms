...
INSERT INTO VERSAO (DTH, NUMERO_VERSAO, SCRIPT) VALUES (SYSDATE, '3.8.2', 'cascadeMapaSeparacao.sql');
...
ALTER TABLE MAPA_SEPARACAO_PEDIDO DROP CONSTRAINT MAPA_SEPARACAO_PEDIDO_MS;
ALTER TABLE MAPA_SEPARACAO_PEDIDO ADD CONSTRAINT MAPA_SEPARACAO_PEDIDO_MS FOREIGN KEY (COD_MAPA_SEPARACAO) REFERENCES MAPA_SEPARACAO (COD_MAPA_SEPARACAO) ON DELETE CASCADE ENABLE;
