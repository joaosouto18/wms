...
(SELECT COD_MENU_ITEM FROM MENU_ITEM WHERE COD_PAI IN (SELECT COD_MENU_ITEM FROM MENU_ITEM WHERE DSC_MENU_ITEM = 'Cadastros') AND DSC_MENU_ITEM = 'Modelo de Armazenagem'), 'Modelo', 10, '#', '_self', 'S');
