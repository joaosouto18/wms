...
CREATE OR REPLACE FORCE VIEW "V_QTD_RECEBIMENTO" ("QTD", "COD_RECEBIMENTO", "COD_PRODUTO", "DSC_GRADE", "COD_OS", "NUM_PESO", "LOTE") AS
SELECT MIN(QTD.QTD) as QTD,
    ...
    GROUP BY QTD.COD_PRODUTO, QTD.COD_RECEBIMENTO, QTD.DSC_GRADE, QTD.COD_OS, QTD.NUM_PESO, QTD.LOTE
    UNION
...
--DETALHADA
CREATE OR REPLACE FORCE VIEW "V_QTD_RECEBIMENTO_DETALHADA" ("QTD", "COD_RECEBIMENTO", "COD_PRODUTO", "DSC_GRADE", "COD_OS", "COD_NORMA_PALETIZACAO", "NUM_PESO", "LOTE") AS
SELECT MIN(QTD.QTD) as QTD,
      QTD.COD_RECEBIMENTO,
      QTD.COD_PRODUTO,
      QTD.DSC_GRADE,
    ...
    GROUP BY QTD.COD_PRODUTO, QTD.COD_RECEBIMENTO, QTD.DSC_GRADE, QTD.COD_OS, QTD.NUM_PESO, QTD.COD_NORMA_PALETIZACAO, QTD.LOTE
    UNION
    SELECT SUM(RE.QTD_CONFERIDA * RE.QTD_EMBALAGEM) AS QTD,
      RE.COD_RECEBIMENTO,
      PE.COD_PRODUTO,
