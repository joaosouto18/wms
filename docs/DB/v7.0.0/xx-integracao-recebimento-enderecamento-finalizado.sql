...
BEGIN
  SELECT FUNC_CHECK_SCRIPT('xx-integracao-recebimento-enderecamento-finalizado.sql', '') INTO CHECK_RESULT FROM DUAL ;
  IF (CHECK_RESULT <> 'TRUE') THEN 
    DBMS_OUTPUT.PUT_LINE(CHECK_RESULT);
  ELSE 
        INSERT INTO VERSAO (DTH, NUMERO_VERSAO, SCRIPT) VALUES (SYSDATE, '7','xx-integracao-recebimento-enderecamento-finalizado.sql');
/************************************************************************
