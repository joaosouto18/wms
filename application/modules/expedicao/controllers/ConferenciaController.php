            ...
            if ($submit == 'semConferencia') {
                if ($senhaDigitada == $senhaAutorizacao) {
                    ...
                    foreach ($mapaSeparacaoConferenciaEntities as $mapaSeparacaoConferenciaEntity) {
                        ...
                        $mapaSeparacaoRepository->adicionaQtdConferidaMapa($embalagemEntity,$volumeEntity,$mapaSeparacaoEntity,null,$mapaSeparacaoConferenciaEntity['QTD_CONFERIR'], null, $ordemServicoId);
                    }
