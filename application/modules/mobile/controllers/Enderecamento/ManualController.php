        ...
        try{
            if ($this->getRequest()->isPost()) {
                ...
                if (empty($params['reservas'])) {
                    ...
                    $paleteProdutoEn = $paleteProdutoRepo->getQtdTotalEnderecadaByRecebimento($params['id'], $codProduto, $grade, $params['produto'], $lote);
...
//                    var_dump($enderecadoMaisEnderecar);die;
    ...
    public function enderecarManualAction(){
        ...
        try {
            ...
            if (empty($params['reservas'])) {
                ...
                $paleteProdutoEn = $paleteProdutoRepo->getQtdTotalEnderecadaByRecebimento($idRecebimento, $codProduto, $grade, $codBarras, $lote);
                ...
                $paleteEn = $this->createPalete($qtd,$produtoEn, $idRecebimento, $codBarras, $lote);
            ...
            $file = fopen(APPLICATION_PATH. "/../log/erro.txt", 'a');
     ...
     */
    private function createPalete($qtd, $produtoEn, $idRecebimento, $codBarras, $lote = null)
    {
        /** @var \Wms\Domain\Entity\ProdutoRepository $produtoRepo */
        $produtoRepo    = $this->em->getRepository('wms:Produto');
