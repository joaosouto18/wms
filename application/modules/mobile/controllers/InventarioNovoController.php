...
class Mobile_InventarioNovoController extends Action
{
    ...
    public function getInfoProdutoAction()
    {
        try {
            ...
            $elemento = $this->_em->getRepository('wms:Produto')->getEmbalagemByCodBarras($this->_getParam("codbarras"), $this->_getParam("conEnd"))[0];

            if (empty($elemento))
                throw new Exception("Nenhuma embalagem/volume ativo foi encontrado com esse código de barras". $this->_getParam("conEnd"));
