...
class Mobile_ConsultaProdutoController extends Action
{
    public function indexAction()
    {
        ...
        if ($codigoBarras != NULL) {
            ...
            $this->view->pulmoes = $estoqueRepo->getEstoqueAndVolumeByParams($params, null, true, "ORDER BY E.DTH_VALIDADE, C.COD_CARACTERISTICA_ENDERECO, DE.DSC_DEPOSITO_ENDERECO", false, true);
