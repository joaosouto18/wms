    ...
    template:
        '<div ng-show="display">' +
            '<div class="ui-dialog ui-widget ui-widget-content ui-corner-all" tabindex="-1" role="dialog" aria-labelledby="ui-dialog-title-wms-dialog-modal"' +
                ' style="display: block; z-index: 1002; outline: 0px; position: absolute; width: 780px; top: 80px; left: 120px;">' +
                                    ...
                                    '<table>' +
                                        '<thead>' +
                                            '<tr>' +
                                                ...
                                                '<th>Comparar com estoque?</th>' +
                                                '<th>Permitir mesmo usuário em N contagens?</th>' +
                                                '<th>Forçar contagem de tudo no endereço?</th>' +
                                        ...
                                        '<tbody>' +
                                            '<tr>' +
                                                ...
                                                '<td valign="center" align="center">{{modSel.controlaValidade}}</td>' +
                    ...
                    '<fieldset id="fs-grid-selected">' +
                        ...
                        '<div class="grid">' +
                            '<div class="gMassAction">' +
                                ...
                                '</div>' +
                                '<div class="gAction">' +
                                    '<button type="button" class="btn-grid" ng-click="criarInventario(criterio)"><span>Concluir</span></button>' +
                                '</div>' +
                            '</div>' +
                            '<table class="gTable" style="width: 708px">' +
                                ...
                                '</tbody>' +
                            '</table>' +
                            '<div ng-show="itens.length" style="overflow-y:scroll; max-height: 340px" >' +
                                '<table class="gTable">' +
