...
class LoaderManager
{
    ...
    private static $LOADERS = array(
        'default'   => 'Bisna\Base\Service\Loader\DefaultLoader',
        'singleton' => 'Bisna\Base\Service\Loader\SingletonLoader'
    );
     ...
     * Constructor
     * 
     * @param Bisna\Base\Service\ServiceLocator $locator 
     */
     ...
     * @param string $name
     * @param Bisna\Base\Service\ServiceLocator $locator
     * @return Bisna\Base\Service\Loader\AbstractLoader
     */
    public function getLoader($name)
    {
        ...
        if ( ! isset($this->instances[$name])) {
            ...
            if ( ! $reflClass->implementsInterface('Bisna\Base\Service\Loader\Loader')) {
