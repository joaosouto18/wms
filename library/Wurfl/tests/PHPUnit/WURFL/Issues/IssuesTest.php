...
class WURFL_Issues_IssuesTest extends PHPUnit_Framework_TestCase {
    ...
    /**
     * Nokia3220 UP.Browser/7.0.v2.3.sql.119 (GUI) MMP/2.0 Push/PO are old phones
     * so it ok to return the opwv if the user-agent is not present in wurfl.
     */
    public static function issue17UnrecognizedDevices() {
        return array(
            array("SAMSUNG-SGH-J700i/J700IXAIA2 Profile/MIDP-2.0 Configuration/CLDC-1.1 UP.Browser/6.v2.3.sql.3.c.1.101 (GUI) MMP/2.0", "samsung_sgh_j700i_ver1"),
            array("Nokia3220 UP.Browser/7.0.v2.3.sql.119 (GUI) MMP/2.0 Push/PO", "nokia_3220_ver1"));
    }
