...
class FiltroUsuario extends \Wms\Module\Web\Form
{
    ...
    public function init()
    {
        ...
        $this->addElement('text', 'nome', [
                'label' => 'Nome do usuário (Ou parte)',
                'class' => 'focus'
            ])
            ->addElement('select', 'idPerfil', array(
            ...
            ->addDisplayGroup(array('nome', 'idPerfil', 'idDeposito', 'isAtivo', 'submit'), 'identificacao', array('legend' => 'Filtros de Busca'));
