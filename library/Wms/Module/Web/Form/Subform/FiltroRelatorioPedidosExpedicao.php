 ...
 */
class FiltroRelatorioPedidosExpedicao extends \Wms\Module\Web\Form
{
    ...
    public function init()
    {
        ...
        $this->setAttribs(array(
            'method' => 'get',
            'class' => 'filtro',
            'id' => 'filtro-pedidos-expedicao-form',
        ));
        ...
        $this->setDecorators(array(array('ViewScript', array('viewScript' => 'relatorio/pedidos-expedicao/filtro.phtml'))));
    }
