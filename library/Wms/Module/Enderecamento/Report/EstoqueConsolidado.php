...
class EstoqueConsolidado extends Pdf
{
    ...
    public function Header()
    {
        ...
        $this->Cell(20, 20, utf8_decode("RELATÓRIO DE ESTOQUE POR PRODUTO CONSOLIDADO"), 0, 1);
        $this->SetFont('Arial', 'B', 8);
        $this->Cell(30,  5, utf8_decode("Código do Produto"), 1, 0);
        $this->Cell(30,  5, utf8_decode("Linha de Separação")   ,1, 0);
    ...
    public function init($params = array())
    {
        ...
        $estoqueReport = $EstoqueRepo->getEstoqueConsolidado($params);
        ...
        $this->Output('EstoqueConsolidado.pdf','D');
    }
}
