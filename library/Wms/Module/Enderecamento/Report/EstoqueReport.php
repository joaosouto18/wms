...
class EstoqueReport extends Pdf
{
    ...
    public function init($params = array())
    {
        ...
        $SQLorder = " ORDER BY E.COD_PRODUTO, E.DSC_GRADE, DE.DSC_DEPOSITO_ENDERECO, E.NORMA, E.VOLUME, C.COD_CARACTERISTICA_ENDERECO, E.DTH_PRIMEIRA_MOVIMENTACAO, E.DTH_VALIDADE ";
