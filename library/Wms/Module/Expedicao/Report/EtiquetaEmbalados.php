...
class EtiquetaEmbalados extends eFPDF
{
    ...
    private function bodyExpedicaoModelo1($volume,$existeItensPendentes)
    {
        ...
        $impressao = utf8_decode(substr("CLI: ".$volume[0]['NOM_PESSOA']."\n\n",0,50));
        ...
        $this->SetXY(85,$y+20);
        $this->Cell(90,$y+10, $impressao, 0, 'L');

        $this->Image(@CodigoBarras::gerarNovo($volume[0]['COD_MAPA_SEPARACAO_EMB_CLIENTE']) , 69, 20 , 35);
    }
