...
class ProdutosCarregamento_modelo2 extends Pdf
{
    ...
    private function bodyPage($data, $dataEmb = null, $embalagemRepo = null){
        ...
        if (isset($dataEmb) && !empty($dataEmb)) {
            ...
            $this->Cell(20, 6, $qtdCaixas . ' ' . $embMaster);
    ...
    public function imprimir($idExpedicao,$idLinhaSeparacao)
    {
        ...
        foreach ($resultado as $chave => $valor) {
            ...
            if ($valor['DSC_LINHA_SEPARACAO'] != $linhaSeparacaoAnt || $valor['SEQUENCIA'] != $sequenciaAnt) {
                ...
                $this->Cell(20, 10, utf8_decode("Motorista/RG: ____________________________________________________"),0,1);
                $this->Cell(20, 10, utf8_decode("Transportadora:__________________________________________________"),0,1);
