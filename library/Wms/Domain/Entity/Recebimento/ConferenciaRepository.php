...
class ConferenciaRepository extends EntityRepository
{
    ...
    {
        $sql = $this->getEntityManager()->createQueryBuilder()
            ->select('1010101010 codigoBarras, nfi.codProduto, nfi.grade, SUM(nfi.quantidade) quantidade, SUM(nfi.quantidade) - NVL(SUM(v.qtd),0) qtdDivergencia, nf.codRecebimentoErp, rc.dataValidade, rc.dataConferencia')
