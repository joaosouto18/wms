...
class NotaFiscalRepository extends EntityRepository {
    ...
    public function getConferencia($idFornecedor, $numero, $serie, $dataEmissao, $idStatus) {
        ...
        $sql = "
            SELECT DISTINCT NFI.COD_PRODUTO, NFI.DSC_GRADE, NFI.QTD_ITEM, NF.DAT_EMISSAO, (NFI.QTD_ITEM + NVL(RC2.QTD_DIVERGENCIA, 0)) AS QTD_CONFERIDA, NVL(RC.QTD_AVARIA,0) AS QTD_AVARIA, NVL(MDR.DSC_MOTIVO_DIVER_RECEB,'') AS DSC_MOTIVO_DIVER_RECEB, NFI.NUM_PESO AS PESO_ITEM
            FROM NOTA_FISCAL NF
            ...
            WHERE NF.COD_FORNECEDOR = '$idFornecedor' 
                ...
                AND TO_CHAR(NF.DAT_EMISSAO, 'DD/MM/YYYY') = '$dataEmissao'
