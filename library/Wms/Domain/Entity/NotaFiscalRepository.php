...
class NotaFiscalRepository extends EntityRepository {
    ...
    public function getConferencia($idFornecedor, $numero, $serie, $dataEmissao, $idStatus) {
        ...
        $sql = "
            SELECT NFI.COD_PRODUTO, NFI.DSC_GRADE, NFI.QTD_ITEM, NF.DAT_EMISSAO, (NFI.QTD_ITEM + NVL(RC2.QTD_DIVERGENCIA, 0)) AS QTD_CONFERIDA, RC.QTD_AVARIA, MDR.DSC_MOTIVO_DIVER_RECEB, NFI.NUM_PESO AS PESO_ITEM
            FROM NOTA_FISCAL NF
            ...
            GROUP BY NFI.COD_PRODUTO, NFI.DSC_GRADE, NFI.QTD_ITEM, NF.DAT_EMISSAO, NFI.QTD_ITEM, RC2.QTD_DIVERGENCIA, RC.QTD_AVARIA, MDR.DSC_MOTIVO_DIVER_RECEB
";
