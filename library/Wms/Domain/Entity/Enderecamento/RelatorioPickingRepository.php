...
class RelatorioPickingRepository extends EntityRepository
{
    ...
    public function getDescricaoSelecionadosOrdenado() {
        $sql = "
            SELECT a.COD_DEPOSITO_ENDERECO, a.DESCRICAO
            FROM (
                SELECT DISTINCT DE.COD_DEPOSITO_ENDERECO, DE.DSC_DEPOSITO_ENDERECO as DESCRICAO, MOD(DE.NUM_PREDIO,2) as LADO, DE.NUM_RUA, DE.NUM_PREDIO, DE.NUM_APARTAMENTO
