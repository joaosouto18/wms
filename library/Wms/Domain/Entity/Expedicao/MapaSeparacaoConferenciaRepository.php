...
class MapaSeparacaoConferenciaRepository extends EntityRepository
{
    ...
    {
        $sql = "SELECT PP.QUANTIDADE_CONFERIDA, PP.SEQUENCIA, C.COD_CARGA_EXTERNO, PROD.COD_PRODUTO, PROD.DSC_GRADE, PROD.DSC_PRODUTO, LS.DSC_LINHA_SEPARACAO, E.DTH_INICIO
                    ...
                    LEFT JOIN (SELECT E.COD_EXPEDICAO, C.COD_CARGA, PP.COD_PRODUTO, PP.DSC_GRADE, P.SEQUENCIA, SUM(PP.QUANTIDADE - NVL(PP.QTD_CORTADA,0)) QUANTIDADE_CONFERIDA
                                FROM EXPEDICAO E
                                ...
                                GROUP BY E.COD_EXPEDICAO, C.COD_CARGA, PP.COD_PRODUTO, PP.DSC_GRADE, P.SEQUENCIA
                ...
                GROUP BY C.COD_CARGA, PP.SEQUENCIA, C.COD_CARGA_EXTERNO, PROD.COD_PRODUTO, PROD.DSC_GRADE, PROD.DSC_PRODUTO, PP.QUANTIDADE_CONFERIDA, LS.COD_LINHA_SEPARACAO, LS.DSC_LINHA_SEPARACAO, E.DTH_INICIO
                ORDER BY LS.COD_LINHA_SEPARACAO, PP.SEQUENCIA, PROD.COD_PRODUTO";
    ...
    {
        $sql = "SELECT  COUNT(DISTINCT MSE.COD_MAPA_SEPARACAO_EMB_CLIENTE) QUANTIDADE_CONFERIDA, PP.SEQUENCIA, C.COD_CARGA_EXTERNO, P.NOM_PESSOA, MSE.COD_MAPA_SEPARACAO_EMB_CLIENTE, MS.DSC_QUEBRA, E.DTH_INICIO, P.COD_PESSOA
                    FROM MAPA_SEPARACAO_CONFERENCIA CONF
                    INNER JOIN MAPA_SEPARACAO_EMB_CLIENTE MSE ON MSE.COD_MAPA_SEPARACAO_EMB_CLIENTE = CONF.COD_MAPA_SEPARACAO_EMBALADO
                    INNER JOIN MAPA_SEPARACAO MS ON MS.COD_MAPA_SEPARACAO = CONF.COD_MAPA_SEPARACAO
                    INNER JOIN EXPEDICAO E ON MS.COD_EXPEDICAO = E.COD_EXPEDICAO
                    LEFT JOIN (
                          SELECT E.COD_EXPEDICAO, C.COD_CARGA, PP.COD_PRODUTO, PP.DSC_GRADE, P.SEQUENCIA, SUM(PP.QUANTIDADE - NVL(PP.QTD_CORTADA,0)) QUANTIDADE_CONFERIDA
                          FROM EXPEDICAO E
                          INNER JOIN CARGA C ON E.COD_EXPEDICAO = C.COD_EXPEDICAO
                          INNER JOIN PEDIDO P ON P.COD_CARGA = C.COD_CARGA
                          INNER JOIN PEDIDO_PRODUTO PP ON PP.COD_PEDIDO = P.COD_PEDIDO
                    ...
                    WHERE MS.COD_EXPEDICAO = $idExpedicao
                    GROUP BY PP.SEQUENCIA, P.NOM_PESSOA, MSE.COD_MAPA_SEPARACAO_EMB_CLIENTE, C.COD_CARGA_EXTERNO, MS.DSC_QUEBRA, E.DTH_INICIO, P.COD_PESSOA
