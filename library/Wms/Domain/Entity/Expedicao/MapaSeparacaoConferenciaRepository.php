...
class MapaSeparacaoConferenciaRepository extends EntityRepository
{
    ...
    {
        $sql = "SELECT DISTINCT C.COD_CARGA_EXTERNO CARREGAMENTO, P.NOM_PESSOA CLIENTE, MSC.COD_PRODUTO, PROD.DSC_PRODUTO PRODUTO, (PP.QUANTIDADE - NVL(PP.QTD_CORTADA,0)) QUANTIDADE
                    FROM MAPA_SEPARACAO_CONFERENCIA MSC
                ...
                WHERE MS.COD_EXPEDICAO = $idExpedicao AND MSC.COD_PESSOA IS NULL
