...
class MapaSeparacaoConferenciaRepository extends EntityRepository
{
    ...
    {
        $sql = "SELECT C.COD_CARGA_EXTERNO CARREG, P.NOM_PESSOA CLIENTE, MSC.COD_PRODUTO COD_PROD, PROD.DSC_PRODUTO PRODUTO, SUM(PP.QUANTIDADE - NVL(PP.QTD_CORTADA,0)) QTD
                    FROM MAPA_SEPARACAO_CONFERENCIA MSC
