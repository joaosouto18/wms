...
class MapaSeparacaoConferenciaRepository extends EntityRepository
{
    ...
    {
        $sql = "SELECT C.COD_CARGA_EXTERNO CARREGAMENTO, P.NOM_PESSOA CLIENTE, MSC.COD_PRODUTO, PROD.DSC_PRODUTO PRODUTO, SUM(PP.QUANTIDADE - NVL(PP.QTD_CORTADA,0)) QUANTIDADE
                    FROM MAPA_SEPARACAO_CONFERENCIA MSC
