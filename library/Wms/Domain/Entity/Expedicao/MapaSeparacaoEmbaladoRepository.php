...
class MapaSeparacaoEmbaladoRepository extends EntityRepository
{
    ...
    {
        $SQL = "SELECT C.COD_CARGA_EXTERNO CARREGAMENTO, MSE.COD_MAPA_SEPARACAO_EMB_CLIENTE COD_EMBALADO, P.NOM_PESSOA CLIENTE, MSE.NUM_SEQUENCIA SEQUENCIA, S.DSC_SIGLA STATUS
                    FROM MAPA_SEPARACAO MS
