...
class MapaSeparacaoEmbaladoRepository extends EntityRepository
{
    ...
    {
        $SQL = "SELECT C.COD_CARGA_EXTERNO CARREGAMENTO, P.NOM_PESSOA CLIENTE, MSE.COD_MAPA_SEPARACAO_EMB_CLIENTE COD_EMBALADO, MSE.NUM_SEQUENCIA SEQUENCIA, S.DSC_SIGLA STATUS
                    FROM MAPA_SEPARACAO MS
