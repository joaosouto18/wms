...
class Recebimento
{
     ...
     * @param int usuarioId
     */
    public function addAndamento($statusId = false, $usuarioId = false, $observacao = false, $codProduto = null, $dscGrade = null, $dataValidade = null, $dataShelflife = null)
    {
        ...
        $andamento->setDataShelflife($dataShelflife);
