...
//                   ORDER BY HIST.DTH_ESTOQUE, DE.NUM_RUA";
    ...
    public function getEnderecosPorProduto($codbarras) {
        ...
        $SQL = "SELECT DISTINCT
                ...
                WHERE IND_ATENDIDA = 'N' AND (PE.COD_BARRAS = '$codbarras' OR PV.COD_BARRAS = '$codbarras')
                GROUP BY DE.DSC_DEPOSITO_ENDERECO,CE.DSC_CARACTERISTICA_ENDERECO, 0, P.COD_PRODUTO, P.DSC_GRADE, P.DSC_PRODUTO, DE.DSC_DEPOSITO_ENDERECO, PE.COD_BARRAS, REP.QTD_RESERVADA";
