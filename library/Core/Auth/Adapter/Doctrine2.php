...
class Doctrine2 implements \Zend_Auth_Adapter_Interface
{
	...
	if (count($resultIdentities) < 1) {
	    ...
	    $this->_authenticateResultInfo['messages'][] = 'Usuário ou senha inválidos.';
	    //$this->_authenticateResultInfo['messages'][] = 'A record with the supplied identity could not be found.';
	    return $this->_authenticateCreateAuthResult();
	} elseif (count($resultIdentities) > 1) {
	    $this->_authenticateResultInfo['code'] = \Zend_Auth_Result::FAILURE_IDENTITY_AMBIGUOUS;
	    $this->_authenticateResultInfo['messages'][] = 'Mais de um registro foi encontrado para o usuário enviado.';
		...
		$this->_authenticateResultInfo['messages'][] = 'Sucesso na autenticação.';
