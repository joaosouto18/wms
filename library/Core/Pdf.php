...
class Pdf
{
    ...
    public function __construct($orientation = 'P', $unit = 'mm', $size = 'A4')
    {
        ...
        // Font path
        $this->fontpath = dirname(__FILE__) . '/Pdf/font/';
        // Core fonts
        ...
        $this->StdPageSizes = array('a3' => array(841.89, 1190.55), 'a4' => array(595.28, 841.89), 'a5' => array(420.94, 595.28),
            'letter' => array(612, 792), 'legal' => array(612, 1008), 'etiqueta' =>array(110,40) );
     ...
     * @param string $dest Define o tipo de destino que deseja dar ao arquivo:
     *  I - Envia para a saida normal
     *  D - Download o arquivo
     *  F - Salva o arquivo localmente
     *  S - Retorna uma string do arquivo
     * @return string 
     */
