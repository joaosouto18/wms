...
abstract class ARender 
{
	...
	foreach ($options as $key => $value) {
		...
		throw new \Core\Grid\Exception("Unknown option {$method}");
	}
	return $this;
    }
     ...
     * @param Core\Grid\Column\Filter $filter
     * @return ARender 
     */
    public function setFilter(\Core\Grid\Column\Filter $filter)
    {
	$this->filter = $filter;
	return $this;
    }
