<?php
namespace Core\Html2Pdf\_class\myPdf;

use Core\Html2Pdf\_class\locale\HTML2PDF_locale,
    Core\Html2Pdf\_class\exception\HTML2PDF_exception,
    Core\Html2Pdf\_tcpdf_\tcpdf\TCPDF;
/**
...
require_once(dirname(__FILE__).'/../_tcpdf_/tcpdf.php');
