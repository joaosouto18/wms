...
use Core\Html2Pdf\_class\exception\HTML2PDF_exception,
    Core\Html2Pdf\_class\locale\HTML2PDF_locale,
    Core\Html2Pdf\_class\myPdf\HTML2PDF_myPdf,
    Core\Html2Pdf\_class\parsingHtml\HTML2PDF_parsingHtml,
    Core\Html2Pdf\_class\parsingCss\HTML2PDF_parsingCss;
...
if (!defined('__CLASS_HTML2PDF__')) {
    ...
    require_once(dirname(__FILE__).'/_class/exception.php');
    require_once(dirname(__FILE__).'/_class/locale.php');
    require_once(dirname(__FILE__).'/_class/myPdf.php');
    require_once(dirname(__FILE__).'/_class/parsingHtml.php');
    require_once(dirname(__FILE__).'/_class/parsingCss.php');
